...
#         img(src="static/figs/sbu-logo.jpeg", alt="Stony Brook University Logo", style="max-width: 200px; margin: 10px 0; float: right;"),
...
class CustomConsent(InfoPage, Consent):
    ...
    <p>You are being asked to be in a research study. The purpose of the study is to understand how creativity interacts with using a signal space in the domains of music and communication.</p>

    <p>If you agree to participate, your part will be to be paired up with a partner: you will either have the role of creating sounds on the drum machine or giving feedback on the sounds created by your partner. This will continue over 9 rounds. Finally, you will be asked to answer a short questionnaire about your personal musical abilities and language experience. The amount of time spent in the study is approximately 30 minutes.</p>
    ...
    <p>If you participate in the experiment and questionnaire it means that you have read (or had to read to you) the information in this information sheet, and would like to be a participant.</p>
